      ...
      <div className='my-16'>
        ...
        <div id="mempelai" className='grid md:grid-cols-2 grid-cols-1 gap-4 lg:mx-32 mx-4'>
          <div>
            ...
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#413327] font-bold mb-2'>Aldy Rohmanudin</h1>
            <p data-aos="fade-up" className='text-[#413327] font-semibold text-center md:text-lg text-sm'>Putra Ketiga dari <br /> Bapak Budi & Ibu Asti</p>
          </div>
          <div>
            <center>
            ...
            <h1 data-aos="fade-up" className='text-center custom-font-2 lg:text-6xl text-4xl text-[#413327] font-bold mb-2'>Siska Sumantika</h1>
            <p data-aos="fade-up" className='text-[#413327] font-semibold text-center md:text-lg text-sm'>Putri dari <br /> Bapak Abdul & Ibu Rokayah</p>
          </div>
        </div>
      </div>
